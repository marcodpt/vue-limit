...
new _vue2.default({
  components: {
    'vue-limit': _index2.default
  },
  data: {
    fields: ['page', 'time', 'rows', 'firstLabel', 'previousLabel', 'label', 'nextLabel', 'lastLabel'],
    model: {
      page: 1,
      time: 0,
      rows: 3,
      ...
      buttonStyle: 'margin:0 10px 0 0',
      selectClass: 'input',
      selectStyle: 'margin:0 10px 0 0',
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5d8e89cc", __vue__options__)
  } else {
    hotAPI.reload("data-v-5d8e89cc", __vue__options__)
  }
})()}
},{"../node_modules/vue/dist/vue.js":6,"./index.vue":9,"vue":7,"vue-gh-corners":4,"vue-hot-reload-api":5}],9:[function(require,module,exports){
;(function(){
'use strict';
...
module.exports = {
  ...
  data: function data() {
    return {
      pages: _libt2.default.pager(this.rows)(this.input),
      oldPage: 0,
      interval: null
    };
  },
  ...
  methods: {
    setPage: function setPage(action) {
      var _this = this;

      if (this.time && !this.$data.interval) {
        this.$data.interval = setInterval(function () {
          _this.setPage('rotate');
        }, 1000 * this.time);
      ...
      this.$data.pages = _libt2.default.pager(this.rows)(this.input);
      ...
      if (action === undefined || this.$data.oldPage !== this.model[this.id]) {
        _libt2.default.sync(this.output, _libt2.default.pager(this.rows)(this.model[this.id])(this.input));
      }
    },
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('button',{class:_vm.buttonClass,style:(_vm.buttonStyle),attrs:{"disabled":_vm.model[_vm.id] <= 1},on:{"click":_vm.begin}},[_vm._t("first",[_vm._v(_vm._s(_vm.firstLabel))])],2),_vm._v(" "),_c('button',{class:_vm.buttonClass,style:(_vm.buttonStyle),attrs:{"disabled":_vm.model[_vm.id] <= 1},on:{"click":_vm.back}},[_vm._t("previous",[_vm._v(_vm._s(_vm.previousLabel))])],2),_vm._v(" "),_vm._t("select",[_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.model[_vm.id]),expression:"model[id]"}],class:_vm.selectClass,style:(_vm.selectStyle),on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.$set(_vm.model, _vm.id, $event.target.multiple ? $$selectedVal : $$selectedVal[0])}}},_vm._l((_vm.getOptions()),function(opt){return _c('option',{domProps:{"value":opt.id}},[_vm._v(_vm._s(opt.label))])}))],{id:_vm.id,model:_vm.model,options:_vm.getOptions(),label:_vm.getLabel(_vm.model[_vm.id])}),_vm._v(" "),_c('button',{class:_vm.buttonClass,style:(_vm.buttonStyle),attrs:{"disabled":_vm.model[_vm.id] >= _vm.pages},on:{"click":_vm.next}},[_vm._t("next",[_vm._v(_vm._s(_vm.nextLabel))])],2),_vm._v(" "),_c('button',{class:_vm.buttonClass,style:(_vm.buttonStyle),attrs:{"disabled":_vm.model[_vm.id] >= _vm.pages},on:{"click":_vm.end}},[_vm._t("last",[_vm._v(_vm._s(_vm.lastLabel))])],2)],2)}
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1b63750b", __vue__options__)
  } else {
    hotAPI.reload("data-v-1b63750b", __vue__options__)
  }
})()}
},{"libt":1,"vue":7,"vue-hot-reload-api":5}]},{},[8]);
